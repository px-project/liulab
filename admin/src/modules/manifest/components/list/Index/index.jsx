...
export const ManifestList = (
    { manifest, entities, category, selectManifest, manifest_selected }) => (
        <div className="page manifest-page">
            <header className="page-header">
                <FormSelect options={Object.keys(MANIFEST_STATUS).map((status, index) => ({ key: index, value: status, text: MANIFEST_STATUS[status].name }))}
                    className="group" placeholder="所有状态"></FormSelect>
            ...
            <Menu manifest_selected={manifest_selected} entities={entities}></Menu>
        </div>
    );