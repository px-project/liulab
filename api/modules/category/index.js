...
module.exports = _router
    ...
    .get('/', (req, res) => {
        ...
        categoryModel.list(condition, (result) => {
            res.json(xres({ code: 0 }, xfilter(result, '_id', 'name', 'photo', 'create_time', 'update_time')));
        });
    })
    ...
    .get('/:category_id', (req, res) => {
        ...
        categoryModel.detail(category_id, {}, (result) => {
            res.json(xres({ code: 0 }, xfilter(result, '_id', 'name', 'photo', 'attrs', 'create_time', 'update_time')));
        });
    })
    ...
    // 添加
    .post('/', (req, res) => {
        let newData = xfilter(req.body, 'name', 'photo', 'attrs');
